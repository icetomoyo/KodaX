...
>
> Current release: `v0.7.96-beta`
> (`@kodax-ai/kodax@0.7.96-beta`; Windows `sandboxRuntime:11`,
...
The package release is `@kodax-ai/kodax@0.7.96-beta`, which includes the v2
