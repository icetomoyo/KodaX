...
>
> Current release: `v0.7.96-rc.5`
> (`@kodax-ai/kodax@0.7.96-rc.5`; Windows `sandboxRuntime:11`,
...
The package release is `@kodax-ai/kodax@0.7.96-rc.5`, which includes the v2
