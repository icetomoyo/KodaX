...
>
> Current release: `v0.7.96-rc.2`
> (`@kodax-ai/kodax@0.7.96-rc.2`; Windows `sandboxRuntime:11`,
...
The package release is `@kodax-ai/kodax@0.7.96-rc.2`, which includes the v2
