...
>
> Current release: `v0.7.96-beta.9`
> (`@kodax-ai/kodax@0.7.96-beta.9`; Windows `sandboxRuntime:11`,
...
The package release is `@kodax-ai/kodax@0.7.96-beta.9`, which includes the v2
