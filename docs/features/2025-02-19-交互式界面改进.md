...
> **状态**: 🚧 Phase 5 规划中 | **更新日期**: 2026-02-20
>
...
| 任务 | 优先级 | 文件 | 状态 |
|------|--------|------|------|
| 5.1.1 移除 Logo 与输入间的空行 | P0 | `InkREPL.tsx` | 待实现 |
| 5.1.2 合并 Logo/版本/Provider 到一行 | P0 | `InkREPL.tsx` | 待实现 |
| 5.2.1 创建 SessionHistory 组件 | P1 | `SessionHistory.tsx` | 待实现 |
| 5.2.2 集成到 InkREPL 启动流程 | P1 | `InkREPL.tsx` | 待实现 |
| 5.3.1 修改 useInputHistory 支持多行 | P0 | `useInputHistory.ts` | 待实现 |
| 5.3.2 实现边界历史导航逻辑 | P0 | `InputPrompt.tsx` | 待实现 |
| 5.3.3 添加单元测试 | P1 | `tests/` | 待实现 |
