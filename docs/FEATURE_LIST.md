...
| Item | Value |
|---|---|
| Current released version | `v0.7.96-beta.1` (Git tag / GitHub pre-release) |
| Current package version | `@kodax-ai/kodax@0.7.96-beta.1` (npm publication remains manual) |
| Workspace baseline | `llm / agent / coding / repl` 4 packages |
| In development | `v0.7.97` / `FEATURE_298` — implementation in progress; approved design and tickets |
...
|---|---|---|---|---|---|
| `298` | Product Host and Client Contract Simplification | Core / Runtime + UI SDK + Execution | Critical | `v0.7.97` | [v0.7.97](features/v0.7.97.md#feature-298) — implementation in progress |
...
`v0.7.96-beta.1` is the first beta pre-release of the v0.7.96 line. It retains
