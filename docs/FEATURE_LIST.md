...
| `019` | Session Tree, Checkpoints, and Rewindable Task Runs | New | High | `v0.7.0` | [v0.7.0](features/v0.7.0.md#feature_019-session-tree-checkpoints-and-rewindable-task-runs) |
...
- `FEATURE_022` is the umbrella feature for the current architecture shift. `FEATURE_019`, `FEATURE_025`, `FEATURE_029`, and `FEATURE_034` are enabling slices beneath it.
...
- [Feature Design Index](features/README.md)
- [ADR](ADR.md)
- [HLD](HLD.md)
- [DD](DD.md)
- [PRD](PRD.md)
