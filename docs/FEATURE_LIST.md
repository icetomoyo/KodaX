...
| Item | Value |
|---|---|
| Current released version | `v0.7.96-beta` (Git tag / GitHub pre-release) |
| Current package version | `@kodax-ai/kodax@0.7.96-beta` (npm publication remains manual) |
...
## v0.7.96-beta Release Record

`v0.7.96-beta` is the consolidated beta of the v0.7.96 line, carrying every
