...
| Released implementation | [FEATURE_299 v0.7.96](features/v0.7.96.md#feature_299-unified-stop-full-access-and-extension-execution-contracts) — released in `v0.7.96-beta.9`, extended through `v0.7.96-rc.7` |
...
`v0.7.96-rc.6` was the sixth release candidate of the v0.7.96 line. It
