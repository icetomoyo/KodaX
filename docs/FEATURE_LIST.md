...
| Item | Value |
|---|---|
| Tracked feature IDs | `001-105` (026 removed) |
| Total tracked features | `104` |
| Completed | `80` |
| Cancelled | `2` |
| Absorbed | `2` |
| InProgress | `1` |
