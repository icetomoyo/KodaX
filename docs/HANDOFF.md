...
> 2026-09-08 更新：用户已明确授权继续按设计修复，并在修复后合并主仓库最新进展。下文 2026-09-05 的停止指令及后续 GLM 门禁仅是历史记录，不再代表当前状态。本轮复查整改和实际验证以 [REVIEW_v0.7.97_FINAL.md](REVIEW_v0.7.97_FINAL.md) 的 2026-09-08 节及 [正式票据](features/v0.7.97.md) 为准。尚未推送或发布。
