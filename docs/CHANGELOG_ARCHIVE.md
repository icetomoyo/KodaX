...
Archived changelog entries for versions prior to v0.7.0.

> For the active changelog (v0.7.0+), see [CHANGELOG.md](../CHANGELOG.md).
...
- **Issue 011/012**: Command preview length + ANSI Strip performance
- **Issue 010**: Missing explicit null checks
...
### Fixed
- **Issue 045**: Spinner response ordering issue
