...
describe('FEATURE_218 manual registry', () => {
  ...
  it('documents the FEATURE_295 trusted-text and native-shell boundary', () => {
    ...
    expect(sandbox).toContain('refreshed v0.7.96-alpha.6 source candidate uses Windows native shell protocol 10');
  ...
  it('documents the v0.7.96 release capability and capacity-debt contracts', () => {
    ...
    expect(sdk).toContain('The refreshed v0.7.96-alpha.6 source candidate advertises Windows `sandboxRuntime:11`');
