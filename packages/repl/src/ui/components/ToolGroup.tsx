...
export const ToolCallDisplay: React.FC<ToolCallDisplayProps> = ({
  ...
  return (
    <Box flexDirection="column" marginLeft={2}>
      ...
      {/* Tool output is NOT rendered here: the live transcript renders
          tool results through the flat TranscriptRow[] model
          (transcript-layout.ts buildToolRows / pushDiffRows), not this
          component tree — the FEATURE_141 ToolOutputBlock/DiffHunk path
          was never reachable and was removed. */}
