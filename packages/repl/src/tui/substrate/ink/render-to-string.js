...
@example
```
import {renderToString, Text, Box} from './index.js';
...
const renderToString = (node, options) => {
    ...
    // Create a standalone root node â€?no stdout, stdin, or terminal bindings
    ...
    try {
        ...
        // Render the DOM tree to a string â€?this captures the dynamic (non-static) output.
        ...
        // reconciler's removeChildFromContainer â†?cleanupYogaNode â†?freeRecursive.
