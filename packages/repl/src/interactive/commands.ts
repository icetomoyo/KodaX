...
export const BUILTIN_COMMANDS: Command[] = [
  ...
  },
  {
    ...
    detailedHelp: () => {
      ...
      console.log(chalk.dim('  /mode accept-edits           ') + 'Sandbox first; user decides only at the host boundary');
      console.log(chalk.dim('  /mode auto                   ') + 'Sandbox first; LLM review only at the host boundary');
      console.log(chalk.dim('  /mode full-access            ') + 'Run directly on the host after Exec Policy');
      console.log();
      ...
      console.log(chalk.green('  accept-edits  ') + chalk.dim('- Sandbox first; user decides host-boundary fallbacks'));
      console.log(chalk.green('  auto          ') + chalk.dim('- Sandbox first; LLM reviews host-boundary fallbacks'));
      console.log(chalk.red('  full-access   ') + chalk.dim('- Direct host execution; Exec Policy still applies'));
      console.log();
      console.log(chalk.bold('Notes:'));
